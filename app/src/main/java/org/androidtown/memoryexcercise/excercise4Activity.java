...
//        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,  WindowManager.LayoutParams.FLAG_FULLSCREEN);
         setContentView(R.layout.excercise4);
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < 2; i++) {
                    if (answer[i] == 0) {
                        ...
                        answerCount++;
                        countResult.setText("찾은 과일(" + answerCount + "/" + answerNumber + ")");
                        break;
                    }
                }
                if (found == 0) {
    ...
    public void chanceFail()
    {
        ...
        {
            playChance.setText("(마지막 기회 입니다)");
        }
        else if(chance > 0)
            playChance.setText("(남은 기회는 " + chance + "번 입니다)");
